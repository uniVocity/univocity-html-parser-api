...
public interface PaginationGroupStart {
	 ...
	 * the parser when parsing fields creating from this group. Returns a {@link PartialPaginationGroup} which allows the further
	 * specification of exactly what element on the page the group will start at. {@link PartialPaginationGroup} also provides
