...
/**
 * Allows further specification of exactly which element the {@link Group} starts at, as well
...
public interface PartialGroup extends ElementFilter<PartialGroup>, ElementFilterStart<PartialGroup> {
	 ...
	 * to create fields from the group. If a closing element (such as {@code </table>, </div>, </p>}, etc) needs to be
	...
	/**
	 * Defines the closing HTML element (such as {@code </table>, </div>, </p>}, etc) where the {@link Group} will end and includes this closing element into the group.
