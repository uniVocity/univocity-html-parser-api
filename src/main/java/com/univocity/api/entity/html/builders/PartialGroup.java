...
/**
 * A class that allows further specification of exactly which element the {@link Group} starts at, as well
 * as where the group will end. This is the last step in creating a {@link Group}. This class is called by
 * {@link GroupStart}
 *
...
public interface PartialGroup extends ElementFilter<PartialGroup>, ElementFilterStart<PartialGroup> {
	...
	/**
	 * Defines the HTML element where the {@link Group} will end. As it returns a {@link Group} itself, it allows
	 ...
	 * @return a {@link Group} to specify the exact element where the group will closes as well as allowing the
	 * addition of fields to the group.
	 */
	Group endAt(String elementName);

	/**
	 * Defines the HTML element where the {@link Group} will end and includes this closing element into the group.
	 * As it returns a {@link Group} itself, it allows the further specification of exactly which HTML element the
